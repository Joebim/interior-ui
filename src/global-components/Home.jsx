...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full sm:h-[100vh] p-[20px] justify-center items-center bg-gray-50">
        <div className="h-full relative w-full justify-end items-end overflow-hidden bg-white rounded-[40px] shadow-lg flex flex-col gap-[30px]">
              ...
              <div className="flex flex-col w-full gap-[30px]">
                ...
                <div className="w-full relative flex flex-col gap-[15px]  overflow-hidden">
                  ...
                  <div className="absolute h-full w-full flex items-center justify-between">
                    <div className="h-full w-[100px] flex items-center group justify-start pl-[8px]">
                      <div className="h-[40px] relative w-[40px] cursor-pointer shadow-md flex justify-center items-center z-[4] invisible  group-hover:visible bg-white duration-150 rounded-full"
                        onClick={previousSlide}
                      >
                        <MdKeyboardArrowLeft className="text-[20px] text-[black]" />
                      </div>
                    </div>
                    <div className="h-full w-[100px] flex items-center group justify-end pr-[20px]">
                      <div className="h-[40px] relative w-[40px] cursor-pointer shadow-md flex justify-center items-center z-[4] invisible  group-hover:visible bg-white duration-150 rounded-full"
                        onClick={nextSlide}
                      >
